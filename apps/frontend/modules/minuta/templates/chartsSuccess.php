...
<script type="text/javascript">
  ...
  {
    data_series2[i] = data_series[i] / <?php echo $max_valor_ind ?> * 100;
  }
  ...
  $(document).ready(function() {
    $('#container').highcharts({
      ...
      title: {
        text: 'Indicador Asistencia (2013)'
      },
      xAxis: [{
...
<script type="text/javascript">
  ...
  var data_series_pendientes = new Array(<?php echo Doctrine_Core::getTable('SAF_COMP_UE')->getCompromisos($unidades,'PENDIENTE'); ?>);
  var data_series_terminados = new Array(<?php echo Doctrine_Core::getTable('SAF_COMP_UE')->getCompromisos($unidades,'TERMINADO'); ?>);
