CREATE TABLE SAF_AGENDA_CONVOCATORIA (id NUMBER(20), departamento VARCHAR2(50) NOT NULL, observacion VARCHAR2(1000), created_at DATE NOT NULL, updated_at DATE NOT NULL, PRIMARY KEY(id))TABLESPACE "TS_DAT_EVENTOS_SOD"
/
...
/
CREATE TABLE SAF_CONVOCATORIA_CAF (id NUMBER(20), asunto VARCHAR2(100) NOT NULL, fecha DATE NOT NULL, hora_ini DATE NOT NULL, hora_fin DATE NOT NULL, lugar VARCHAR2(100) NOT NULL, status VARCHAR2(50) NOT NULL, motivo_suspencion VARCHAR2(1000), observacion VARCHAR2(1000), c_caf VARCHAR2(100), created_at DATE NOT NULL, updated_at DATE NOT NULL, PRIMARY KEY(id))TABLESPACE "TS_DAT_EVENTOS_SOD"
/
