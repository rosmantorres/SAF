CREATE TABLE SAF_AGENDA_CONVOCATORIA (id NUMBER(20), departamento VARCHAR2(50) NOT NULL, f_inicio_consulta DATE NOT NULL, f_fin_consulta DATE NOT NULL, observacion VARCHAR2(1000), created_at DATE NOT NULL, updated_at DATE NOT NULL, PRIMARY KEY(id))
/
CREATE TABLE SAF_ASISTENCIA (id_convocatoria NUMBER(20), id_personal NUMBER(20), PRIMARY KEY(id_convocatoria, id_personal))
/
CREATE TABLE SAF_COMP_UE (id NUMBER(20), id_compromiso NUMBER(20) NOT NULL, id_ue NUMBER(20) NOT NULL, PRIMARY KEY(id))
/
CREATE TABLE SAF_CONVOCATORIA_CAF (id NUMBER(20), id_agenda NUMBER(20) NOT NULL, asunto VARCHAR2(100) NOT NULL, hora_ini DATE NOT NULL, hora_fin DATE NOT NULL, lugar VARCHAR2(100) NOT NULL, observacion VARCHAR2(1000), c_caf VARCHAR2(100), created_at DATE NOT NULL, updated_at DATE NOT NULL, PRIMARY KEY(id))
/
CREATE TABLE SAF_EVENTO (id NUMBER(20), descripcion VARCHAR2(500) NOT NULL, clasificado_en VARCHAR2(50) NOT NULL, id_agenda NUMBER(20), id_convocatoria NUMBER(20), c_eveno_t NUMBER(20), c_evento_d NUMBER(20), status VARCHAR2(50), PRIMARY KEY(id))
/
CREATE TABLE SAF_FOTO (id NUMBER(20), tipo VARCHAR2(50) NOT NULL, titulo VARCHAR2(100) NOT NULL, dir VARCHAR2(100) NOT NULL, id_convocatoria NUMBER(20), id_evento NUMBER(20), id_vario NUMBER(20), sub_titulo VARCHAR2(100), PRIMARY KEY(id))
/
CREATE TABLE SAF_F_CONVOCATORIA_CAF (fecha DATE, id_convocatoria NUMBER(20) NOT NULL, status VARCHAR2(50) NOT NULL, motivo_suspencion VARCHAR2(1000), PRIMARY KEY(fecha))
/
CREATE TABLE SAF_PERSONAL (ci NUMBER(20), id_ue NUMBER(20) NOT NULL, nombre VARCHAR2(50), apellido VARCHAR2(50), correo VARCHAR2(50), PRIMARY KEY(ci))
/
CREATE TABLE SAF_R1000_MVAMIN (id NUMBER(20), id_evento NUMBER(20) NOT NULL, razon VARCHAR2(50) NOT NULL, valor NUMBER(20) NOT NULL, PRIMARY KEY(id))
/
CREATE TABLE SAF_TAREA_REALIZADA_COMP (id NUMBER(20), id_comp_ue NUMBER(20) NOT NULL, descripcion VARCHAR2(1000), created_at DATE NOT NULL, updated_at DATE NOT NULL, PRIMARY KEY(id))
/
CREATE TABLE SAF_UNIDAD_EQUIPO (id NUMBER(20), nombre VARCHAR2(50) NOT NULL, correo VARCHAR2(50) NOT NULL, PRIMARY KEY(id))
/
CREATE TABLE SAF_VARIO (id NUMBER(20), id_evento NUMBER(20) NOT NULL, tipo VARCHAR2(50) NOT NULL, descripcion VARCHAR2(4000) NOT NULL, f_duracion_estimada DATE, status VARCHAR2(50), titulo VARCHAR2(100), created_at DATE NOT NULL, updated_at DATE NOT NULL, PRIMARY KEY(id))
/
