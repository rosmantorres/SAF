...
/
CREATE TABLE SAF_COMP_UE (id NUMBER(20), id_compromiso NUMBER(20) NOT NULL, id_ue NUMBER(20) NOT NULL, status VARCHAR2(50) NOT NULL, PRIMARY KEY(id))TABLESPACE "TS_DAT_EVENTOS_SOD"
/
...
/
ALTER TABLE SAF_TAREA_REALIZADA_COMP ADD CONSTRAINT SiSi_22 FOREIGN KEY (id_comp_ue) REFERENCES SAF_COMP_UE(id) NOT DEFERRABLE INITIALLY IMMEDIATE
/
ALTER TABLE SAF_VARIO ADD CONSTRAINT SiSi_23 FOREIGN KEY (id_evento) REFERENCES SAF_EVENTO(id) NOT DEFERRABLE INITIALLY IMMEDIATE
/