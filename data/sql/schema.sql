...
/
CREATE TABLE SAF_MINUTA (cod_min NUMBER(20), id_convocatoria NUMBER(20) NOT NULL UNIQUE, dir_pdf VARCHAR2(50), created_at DATE NOT NULL, updated_at DATE NOT NULL, PRIMARY KEY(cod_min))TABLESPACE "TS_DAT_EVENTOS_SOD"
/
