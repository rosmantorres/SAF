...
abstract class BasesfGuardUserFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'ci'               => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('SAF_ASISTENCIA'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'ci'               => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('SAF_ASISTENCIA'), 'column' => 'id_convocatoria')),
